  ...
  return (
    ...
    <section className='w-full max-w-full flex-start flex-col'>
        ...
        <p className=' desc text-left max-w-md'>
          {type} and share amazing prompt with the world and let your imagination run wild on any AI-platform
        </p>
...
<span className='font-satoshi font-semibold text-base text-gray-700'>
  Tag{` `}
<span className='font-normal'>(#product, #webdev,#design)</span>
</span>
